  ...
  function StuffList() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "checkChecked", function () {
      if (_this.props.lookup.length > 0) {
        _this.props.stuff.map(function (item) {
          var stuffArray = item.ASIN;
        });

        _this.props.lookup.map(function (asin) {
          if (asin.asin.includes(stuffArray)) {
            console.log("this.props.lookup.asin ", true);
            return true;
          } else {
            return false;
            console.log("this.props.lookup.asin ll ", false);
          }
...
//# sourceMappingURL=index.js.b0f6207da64a02587184.hot-update.js.map