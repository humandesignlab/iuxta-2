...
function (_React$Component) {
  ...
  function StuffList() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "checkChecked", function () {
      if (_this.props.stuff.includes(_this.props.lookup.asin)) {
        console.log("this.props.lookup.asin ll ", true);
        return true;
      }
    });
...
//# sourceMappingURL=index.js.5a5691f42fcad15d98b2.hot-update.js.map