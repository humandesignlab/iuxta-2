...
function (_Component) {
  ...
  function Content() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "addItem",
    /*#__PURE__*/
    function () {
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                if (!_this.props.lookup.includes(data.value)) {
                  ...
                  console.log("Already added", _this.props);
                }
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "removeItem",
    /*#__PURE__*/
    function () {
      var _ref3 = _asyncToGenerator(
      /*#__PURE__*/
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3(e, data) {
        var i;
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderList", function () {
      return _this.props.lookup.length > 0 ? _this.props.lookup.map(function (item, index) {
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, index + 1, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_2__["List"].Item, {
          ...
          negative: true,
          size: "mini"
        }, " ", "Remove", " "), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_2__["Divider"], null));
      }) : "Empty List";
    });
...
//# sourceMappingURL=index.js.ec201b799b93a7e52f5b.hot-update.js.map