...
function (_Component) {
  ...
  function Content() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "removeItem", function (e, data) {
      for (var i = _this.props.lookup.length - 1; i >= 0; i--) {
        if (_this.props.lookup.asin[i] === data.value) {
          _this.props.lookup.splice(i, 1);
        }
      }
...
//# sourceMappingURL=index.js.4cab26f4ec08733e6abe.hot-update.js.map